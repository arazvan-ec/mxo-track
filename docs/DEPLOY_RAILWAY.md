...
- **traccar-mxo** (puerto 5055) → `https://TU_DOMINIO_TRACCAR.up.railway.app`
...
| **Server URL** | `https://TU_DOMINIO_TRACCAR.up.railway.app:443` |
...
curl -v "https://TU_DOMINIO_TRACCAR.up.railway.app/?id=test123&lat=40.4168&lon=-3.7038&timestamp=1708100000&speed=0"
```

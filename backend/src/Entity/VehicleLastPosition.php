...
#[ORM\UniqueConstraint(name: 'uniq_vehicle_last_position_public_id', columns: ['public_id'])]
#[ORM\UniqueConstraint(name: 'uniq_vehicle_last_position_vehicle', columns: ['vehicle_id'])]

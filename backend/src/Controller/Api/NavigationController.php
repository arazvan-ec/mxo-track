        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    $this->item('nav.drivers', '/app/admin/drivers', 'driver'),
                    $this->item('nav.routes', '/app/admin/routes', 'route'),
                    $this->item('nav.shipments', '/app/admin/shipments', 'shipment'),
                    ...
                    $this->item('nav.customers', '/app/admin/customers', 'customer'),
            ...
            [
                ...
                'items' => [
                    ...
                    $this->item('nav.reopt_policies', '/app/admin/reoptimization-policies', 'optimization'),
                    $this->item('nav.analytics_opt', '/app/admin/optimization-dashboard', 'reports'),

...
/**
 * Returns test routing comparison data for the React frontend.
 * Replicates the logic from TestRoutingController::map() but returns JSON.
 */
...
class TestRoutingMapDataController extends AbstractController
{
    ...
    #[Route('/api/map/test-routing', name: 'api_map_test_routing', methods: ['GET'])]
    public function __invoke(): JsonResponse
    {
        try {
            ...
            // Build optimized routes via RouteBuilder (VRP)

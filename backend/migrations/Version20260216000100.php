...
final class Version20260216000100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_account (id UUID NOT NULL, customer_id UUID DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id));');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_USER_EMAIL ON user_account (email);');
        $this->addSql('CREATE TABLE vehicle (id UUID NOT NULL, name VARCHAR(120) NOT NULL, traccar_device_id INT DEFAULT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id));');
        ...
        $this->addSql('CREATE TABLE shipment (id UUID NOT NULL, customer_id UUID NOT NULL, reference VARCHAR(80) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));');
        ...
        $this->addSql('CREATE TABLE route_plan (id UUID NOT NULL, driver_id UUID DEFAULT NULL, vehicle_id UUID DEFAULT NULL, name VARCHAR(140) NOT NULL, status VARCHAR(20) NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, end_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));');
        $this->addSql('CREATE TABLE route_stop (id UUID NOT NULL, route_id UUID NOT NULL, sequence INT NOT NULL, address VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, exception_code VARCHAR(30) DEFAULT NULL, exception_notes TEXT DEFAULT NULL, PRIMARY KEY(id));');
        $this->addSql('CREATE INDEX IDX_ROUTE_STOP_SEQUENCE ON route_stop (route_id, sequence);');
        $this->addSql('CREATE TABLE pod (id UUID NOT NULL, route_stop_id UUID NOT NULL, shipment_id UUID DEFAULT NULL, created_by_user_id UUID NOT NULL, signed_by_name VARCHAR(120) NOT NULL, recipient_id_encoded TEXT NOT NULL, confirmed_by_driver BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));');

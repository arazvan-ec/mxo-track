...
final class Version20260222100000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE shipment ADD COLUMN tracking_token VARCHAR(20) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX uniq_shipment_tracking_token ON shipment (tracking_token)');
